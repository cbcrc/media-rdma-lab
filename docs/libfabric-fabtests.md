...
|--------  |---------  |-----------|
| Functional | ~/libfabric/fabtests/functional | core Libfabric functionality such as messaging, RMA, and atomic operations. |
...
**Server Side:**
```bash
lab@server_1 ~/libfabric/fabtests/functional main ± > ./fi_msg -p verbs -s 192.168.0.1
Waiting for message from client...
Data check OK
Received data from client: This msg has been changed
```
**Client Side:**
```bash
lab@server_2 ~/libfabric/fabtests/functional main ± > ./fi_msg 192.168.0.1 -p verbs
Sending message...
